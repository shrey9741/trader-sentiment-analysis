...
1. **Extreme Greed = Best Performance** — Highest avg PnL ($130) and win rate (89.2%). Momentum strategies dominate in bull sentiment.
2. **Fear is an Opportunity** — 87% win rate during Fear periods, second-highest avg PnL ($112). Skilled traders exploit capitulation.
3. **Neutral = Weakest Conditions** — Lowest avg PnL ($71). Low volatility reduces edge; reduce position sizing here.
